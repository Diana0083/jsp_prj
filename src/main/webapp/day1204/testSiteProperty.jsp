...
<link rel ="shortcut icon" href="${ SiteProperty.protocol }${ SiteProperty.server_name }${ SiteProperty.context_root }/jsp_prj/common/images/favicon.ico"/>
