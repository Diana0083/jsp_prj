...
<body>
   ...
   <table id="joinFrm">
      <tr>
         ...
         <td class="input"><input type="text" readonly="readonly" class="inputBox"/><input
            type="button" value="ID 중복확인" class="btnBox"></td>
      </tr>

      <tr>
         <td class="title"><label><span class="star">*</span>비밀번호</label></td>
         <td class="input"><input type="password" class="inputBox"/>&nbsp;<label>비밀번호 확인</label>&nbsp;<input
            type="password" class="inputBox"/></td>
      </tr>

      <tr>
         <td class="title"><label><span class="star">*</span>이름</label></td>
         <td class="input"><input type="text" class="inputBox"/></td>
      </tr>

      <tr>
         <td class="title"><label><span class="star">*</span>생년월일</label></td>
         <td class="input"><input type="date" class="inputBox"/></td>
      </tr>

      <tr>
         <td class="title"><label><span class="star">*</span>연락처</label></td>
         <td class="input"><input type="text" class="inputBox"/></td>
      </tr>

      <tr>
         <td class="title"><label><span class="star">*</span>휴대폰</label></td>
         <td class="input"><select class="inputBox" style="width:120px; height:25px">               <option value="N/A">선택해주세요</option>
               <option value="강원">010</option>
               <option value="경기">011</option>
               <option value="경북">017</option>
               <option value="경남">019</option>
         </select></td>
         <td class="input"><input type="text" class="inputBox" /></td>		 
         <td class="input"><input type="text" class="inputBox" /></td>		 
      </tr>
      ...
      <tr>
         ...
         <td class="input"><input type="text" class="inputBox" style="width: 300px" />@ <input type="text" list="domain" class="inputBox"><input type="checkbox" value="수신">수신
            <datalist id="domain">
      ...
      <tr>
         <td class="title"><label><span class="star">*</span>우편번호</label></td>
         <td class="input"><input type="text" class="inputBox" style="width: 80px" readonly="readonly" /><input
            type="button" value="우편번호 검색" class="btnBox"></td>
      </tr>

      <tr>
         <td  class="title" rowspan="2"><label><span class="star">*</span>주소</label></td>
         <td class="input"><input type="text" readonly="readonly" class="inputBox" style="width:400px"/></td>
      </tr>
      <tr>
         <td class="input"><input type="text" style="width:400px"/></td>
      </tr>
