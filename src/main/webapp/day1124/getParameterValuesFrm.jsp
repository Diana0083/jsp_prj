...
function getSend(){
//js에서는 요청 방식을 변경 할 수 있다.
document.frm.method="get"
//유효성 검증
$("#frm").submit();//jQuery 를 사용한 이동
}
...
<div id="wrap">
   ...
   <a href="#void" onclick="append()"><img src="../day1124/images/btn_append.png"></a>
   <a href="#void" onclick="remove()"><img src="../day1124/images/btn_remove.png"></a>
   </div>
   <div id="licenseDiv">
