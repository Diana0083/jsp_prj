...
try{
	...
	if(obj == null ){
	bs.modifyBoard(tempNum); //세션에 값이 없을 때만 카운트를 올림
	}//end if
	
	BoardDTO bDTO=bs.searchOneBorad(tempNum); //게시글 하나 읽기
...
<link rel="shortcut icon"
	href="http://192.168.10.78/jsp_prj/common/images/favicon.ico">
...
<link href="http://192.168.10.78/jsp_prj/common/css/carousel.css"
	rel="stylesheet">
...
--%>
	$(function() {
		$("#btnModify").click(function() {
			...
			if(confirm("글을 정말 수정하시겠습니까?")){ // 수정 시 반드시 먼저 물어보기
		...
		$("#btnDelete").click(function() {
			...
			if(confirm("글을 정말 삭제하시겠습니까?")){ // 삭제 시 반드시 먼저 물어보기
						...
						<table>
							...
							<tr>
								<td colspan="2" style="text-align: center;"><c:if
										...
										<a href="boardList.jsp?currentPage=${ param.currentPage }"
