...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" info="정상적인 응답 페이지 - 비정상적인 요청이 발생할 수도 있다."%>
...
<%
session.setAttribute("name", "이현아좌-좟 !!");

if( new Random().nextBoolean() ){ //로그인이 안된 경우 ( 세션이 존재하지 않는 경우 )
	//비정상적인 요청이 발생한 경우 
	%>
	<meta http-equiv="refresh" content="5;redirect_.jsp"> <!-- 5; 몇초인지 정하는 수 -->
	<!-- <script type="text/javascript">
	//아래 sendRedirect가 안되면 location.href로 페이지 이동 가능
  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
               정상적인 응답
               <img src="images/redirect.png" title="M자 탈모">
            </div>
