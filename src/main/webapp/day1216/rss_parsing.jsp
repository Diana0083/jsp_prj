	...
	if( confirm( title+" 기사를 보시겠소?") ){
		...
		$.ajax({
			...
			success: function( xmlDoc ){
				...
				output+="기사 : <strong>"+ itemNode.length+"</string>건<br>";
				...
				$.each( itemNodes, function(ind, itemNode ){
					...
					$( itemNode ).find("link").text()+"' title='뉴스 읽기' target='blank'>"+
					itemTitle+"</a></td><th>작성일</th><td>"+
  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
			...
			<td><a href="javascript:requestRss('${commonURL}/day1216/${news.engTitle}','${news.title}')"></a></td>
			</c:forEach>
			</table>
