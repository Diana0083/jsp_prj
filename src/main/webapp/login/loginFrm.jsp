...
<link href="http://192.168.10.78/jsp_prj/common/css/sign-in.css" rel="stylesheet">
<style>
.bd-placeholder-img {
   font-size: 1.125rem;
   text-anchor: middle;
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
   ...
   <main class="form-signin w-100 m-auto">
      <form name="loginFrm" id="loginFrm" action="${ CommonURL }/login/loginFrmProcess.jsp" method="post">
