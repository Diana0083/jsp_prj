...
<body>
  ...
  ================================================== -->
      ...
      <div class="container marketing">
		 ...
		 for( ImgDTO iDTO : list ){ %> <!-- 코딩 영역 for문으로 한번에 만들기 -->
         <hr class="featurette-divider">
         <div class="row featurette">
            <div class="col-md-7">
            <a href="<%= iDTO.getUrl() %>" target="blank">
               <img src="http://192.168.10.78/jsp_prj/common/images/<%= iDTO.getImg()%>"/>
            </a>
            </div>
         ...
         <%if( list.isEmpty()){ %>
          ...
          <div class="row featurette">
            <div class="col-md-7">
            <img src="http://192.168.10.78/jsp_prj/common/images/hyuna.png>"/>
            <br>
            뿌직뿌직 나는야 뿌지직 현아다 ! 뿌우 직
            </div>
