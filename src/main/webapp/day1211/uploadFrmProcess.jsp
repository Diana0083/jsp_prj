  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
			...
			String fileSystemName=mr.getFilesystemName("upfile"); //변경된 이름명
			
			
			//업로드된 파일의 크기를 얻어서. 엄조드 가능 크기와 비교한다
			//파일이 크다면 사용자에게 "에러 메세지를 보여준다." 파ㅣㄹ'
			...
			<%
				...
				e.printStackTrace();
				%>
				파일은 최대 100Byte (10, 485, 760byte)까지만 업로드 가능
				<%
			}//end catch
			%>
